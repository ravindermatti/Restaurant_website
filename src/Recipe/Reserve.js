...
console.log(result)
 ...
 navigate("/")
  ...
  <br />
      <div className="container">
        <div className="row">
          {
         order ? 
            <p style={{color:"red",fontSize:'19px',fontWeight:'bold'}}>(thanks for booking!)</p>
          
       :
        <p style={{color:"red",fontSize:'19px',fontWeight:'bold'}}>(Book right Now)</p>
        }
  ...
  <div className="col-md-4">
    ...
    <input type="text" className="form-control" id="validationDefault01" placeholder="Ravinder Matti" value={name} onChange={(e)=>setName(e.target.value)}/>
  ...
  <div className="col-md-4">
    ...
    <div className="input-group">
      <input type="email" className="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" placeholder="ravindermatti123@gmail.com" value={email} onChange={(e)=>setEmail(e.target.value)} />
    </div>
  </div>
  {/* people */}
  <div className="col-md-4">
    <label htmlFor="validationDefault01" className="form-label">No Of People</label>
    <input type="number" className="form-control" id="validationDefault01" placeholder="66"
    value={people} onChange={(e)=>setPeople(e.target.value)} />
  </div>
  {/* date */}
  <div className="col-md-4">
    <label htmlFor="validationDefault02" className="form-label">Date</label>
    <input type="date" className="form-control" id="validationDefault02" placeholder="01-july-2024" value={date} onChange={(e)=>setDate(e.target.value)} />
  ...
  <div className="col-12">
    <button className="btn reserve-btn" type="submit" onClick={clickHandler}>Book Table</button>
  </div>
