...
<img src="https://images.unsplash.com/photo-1487611459768-bd414656ea10?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" width="260px" height="260px" className='newsImage'/>
    ...
    {
      newsSubscriber?
<button className='news-btn' onClick={clickHandler}>Subscribed</button>
:
<button className='news-btn' onClick={clickHandler}>Subscribe</button>
    }
    ...
    {
      newsSubscriber?
<p style={{color:'red',fontSize:'15px'}}>Thanks for Subscription</p>
:
<p style={{color:'red',fontSize:'15px'}}>Subscribe for updates</p>
    }
